...
from cc_scratch.web_interface.aws import aws_tools, ec2_config, ec2_tools
from cc_scratch.web_interface.models import EC2Instance, VPC, EC2KeyPair, EC2Pool, ElasticIP,\
    AWSAccessKey, Task
import sys, os
