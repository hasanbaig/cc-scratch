...
from cc_scratch.web_interface import views
from cc_scratch.web_interface.account import account_views
from cc_scratch.web_interface.aws import resource_views
from cc_scratch.web_interface.pools import pool_views, task_views
from cc_scratch.web_interface.client_api import api_views
...
#    url(r'^my_account/vpc_status/(?P<key_id>\d+)/remove/$', account_views.VPCRemoveView.as_view(), name='vpc_remove'),
    ...
    url(r'^my_account/pools/(?P<pool_id>\d+)/change_link/$', pool_views.BoscoPoolStatusPageView.as_view(), name='pool_link_change'),
